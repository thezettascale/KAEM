...
file_paths = [
    'logs/uniform_FFT/FMNIST_1/generated_images.h5',
    'logs/lognormal_FFT/FMNIST_1/generated_images.h5',
    'logs/gaussian_FFT/FMNIST_1/generated_images.h5',
]

real_images = 'logs/uniform_FFT/MNIST_1/real_images.h5'

titles = ['Uniform', 'Lognormal', 'Gaussian']
...
# plt.show()
plt.savefig('figures/results/fmnist_priors_fft_13x13.png')
