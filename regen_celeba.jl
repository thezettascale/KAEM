...
t.ps = convert(ComponentArray, saved_data["params"]) |> pu
t.st_kan = convert(NamedTuple, saved_data["kan_state"]) |> pu
t.st_lux = convert(NamedTuple, saved_data["lux_state"]) |> pu
