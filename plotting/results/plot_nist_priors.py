...
for dataset in DATASETS:
    for grid_size in GRID_SIZES:
        for fnc in FNCS:
            ...
            titles = [r"$\mathcal{U}(\bm{z}; \; \bm{0}, \bm{1})$", r"$\text{Lognormal}(\bm{z}; \; \bm{0}, \bm{1})$", r"$\mathcal{N}(\bm{z}; \; \bm{0}, \bm{1})$"]
            ...
            plt.savefig(f'figures/results/{dataset}_priors_{fnc}_{grid_size}x{grid_size}.png')
